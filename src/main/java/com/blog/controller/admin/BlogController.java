...
public class BlogController {
    ...
    public String blogs(QueryBlog queryBlog, Model model){
        PageInfo<Blog> page = blogService.findPage(queryBlog);
    ...
    public String search(QueryBlog queryBlog, Model model){
        PageInfo<Blog> page = blogService.findPage(queryBlog);
        model.addAttribute("page", page);
    ...
    public void uploadFileByEditormd(HttpServletRequest request,
        ...
        //String FILE_UPLOAD_DIC = "/opt/upload/";//上传文件的默认url前缀，根据部署设置自行修改
